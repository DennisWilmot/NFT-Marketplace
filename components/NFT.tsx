...
import { ThirdwebNftMedia, useContract, useValidDirectListings
...
export default function NFTComponent({nft}: Props) {
    ...
    return (
        <Flex direction={"column"} backgroundColor={"#EEE"} 
                ...
                {loadingMarketplace || loadingDirectListing ? (
                    ...
                    <Box>
                        <Flex direction={"column"}>
                            ...
                            <Text fontSize={"small"}>{`{${directListing[0]?.
                                currencyValuePerToken.displayValue}} ${directListing[0]?.
                                currencyValuePerToken.symbol}`}</Text>
